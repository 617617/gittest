# Codex Test Result: atomic_unavailable

Outcome: BLOCK
SelfEvaluation: PASS
ChatCommandReceived: - (none; bk sync said Do not run /bk work)
ExpectedFromSection8: `atomic_unavailable` | Stop with `ATOMIC_PUSH_UNAVAILABLE`
...
ChatCommand: -
HERE: BK_ROLE=codex
WHY: unattended mode requires atomic push of work and coordination branches
...
FailureCode: ATOMIC_PUSH_UNAVAILABLE
...
BLOCK: the atomic push row is unavailable, which maps to ATOMIC_PUSH_UNAVAILABLE.
```
